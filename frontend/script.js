...
function generateDemoProducts() {
  // Only used if backend fails AND no cache exists – these have NO images (will show "No Image")
  ...
  return names.map((name, i) => ({
    ...
    price: 199 + i * 150,
    main_image: '', // No placeholder image
    cat: cats[i] || 'Phones',
...
function createProductCard(p) {
  ...
  // === NO PLACEHOLDER – real image or empty ===
