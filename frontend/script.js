...
const brandLogos = {
    'Apple': 'https://proljdccjrifqgbmsyco.supabase.co/storage/v1/object/public/brands/apple.png',
    'Samsung': 'https://proljdccjrifqgbmsyco.supabase.co/storage/v1/object/public/brands/samsung.png',
    'Huawei': 'https://proljdccjrifqgbmsyco.supabase.co/storage/v1/object/public/brands/huawei.png',
    'Vivo': 'https://proljdccjrifqgbmsyco.supabase.co/storage/v1/object/public/brands/vivo.png',
    'Oppo': 'https://proljdccjrifqgbmsyco.supabase.co/storage/v1/object/public/brands/oppo.png',
    'Xiaomi': 'https://proljdccjrifqgbmsyco.supabase.co/storage/v1/object/public/brands/xiaomi.png',
    'Redmi': 'https://proljdccjrifqgbmsyco.supabase.co/storage/v1/object/public/brands/redmi.png',
    'Honor': 'https://proljdccjrifqgbmsyco.supabase.co/storage/v1/object/public/brands/honor.png',
    'Realme': 'https://proljdccjrifqgbmsyco.supabase.co/storage/v1/object/public/brands/realme.png'
};
...
function buildMainMenu() {
    ...
    brandList.forEach(brand => {
        ...
        brandDiv.innerHTML = `<img src="${imgUrl}" style="width:24px;height:24px;vertical-align:middle;margin-right:4px;" loading="lazy" onerror="this.src='https://cdn-icons-png.flaticon.com/512/1055/1055685.png'"> ${brand}`;
...
async function showRandomPromo() {
    try {
        ...
        if (promo) {
            ...
            document.getElementById('popupContent').innerHTML = `<img src="${promo.image_url || 'https://picsum.photos/300/150'}" loading="lazy" onerror="this.src='https://picsum.photos/300/150?grayscale'"><div><strong>${promo.title}</strong><br>${promo.description}<br><a href="${promo.link}" target="_blank">Shop now</a></div>`;
